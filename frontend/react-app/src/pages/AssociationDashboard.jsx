...
import api, { getUpcomingSessions, getUsers } from "../api";
      ...
      if (storedUser) {
        ...
        try {
          const [resEvents, resUsers] = await Promise.all([
            getUpcomingSessions(),
            api.get("/users?filters[user_type]=student"), // Assuming students are potential members
          ]);
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left">
            ...
            <tbody className="divide-y divide-slate-50">
              ...
              {/* Mock members since we're filtering user_type student */}
              {[1, 2, 3].map((i) => (
                <tr key={i}>
