            ...
            <div className="space-y-4">
                {sessions.length > 0 ? (
                    sessions.map((session) => (
                        <div key={session.id} className="flex gap-4 p-4 items-start border-l-4 border-orange-400 bg-orange-50/50 rounded-r-xl">
                            <div className="text-center min-w-[50px]">
                                <div className="text-lg font-bold text-orange-600">{session.day}</div>
                                <div className="text-xs uppercase text-gray-500">{session.month}</div>
                            </div>
                            <div>
